...
# establish a temporary session connection
db = Session()

# prep the db session object by inserting users
db.add_all([
...
# run the INSERT statement for Users
db.commit()

# preps Post insertions
db.add_all([
    Post(title='Donec posuere metus vitae ipsum', post_url='https://buzzfeed.com/in/imperdiet/et/commodo/vulputate.png', user_id=1),
    Post(title='Morbi non quam nec dui luctus rutrum', post_url='https://nassa.gov/donec.json', user_id=1),
...
# runs the INSERT statement for Posts
db.commit()
